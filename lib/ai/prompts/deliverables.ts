...
{
  "items": [
    { "phase": "Phase 1", "name": "Deliverable name (3-6 words)", "description": "1 short sentence on what it is", "acceptance": "1 clear, testable acceptance criterion with a named artifact or metric" }
    // EXACTLY 6 deliverables — one per phase, plus one more in the core implementation phase
  ],
  "milestones": [
    { "name": "Milestone name (3-5 words)", "target": "Week X or specific date" }
    // EXACTLY 4 milestones at major gate points (Design Sign-off, Alpha Release, UAT Complete, Production Go-Live)
  ]
}
